...
alter table if exists public.cms_tasks add column if not exists group_name text default 'My Tasks';
alter table if exists public.cms_tasks add column if not exists progress integer default 0;
alter table if exists public.cms_tasks add column if not exists lead_name text;
alter table if exists public.cms_tasks add column if not exists members text[] default '{}';
