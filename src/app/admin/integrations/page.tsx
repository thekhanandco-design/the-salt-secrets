...
import { AlertTriangle, Cable, CheckCircle2, Clock3, ExternalLink, RefreshCw, Search, Settings2, X } from "lucide-react";
...
export default function Integrations() {
  ...
  return <AdminShell><div className="os-page integrations-page"><header className="os-page-header"><div><div className="os-page-eyebrow">Credential-aware connection registry</div><h1 className="os-page-title">Integrations</h1><p className="os-page-subtitle">Review and configure analytics, AI, email, social, cloud and infrastructure connections from one secure workspace.</p></div><div className="os-page-actions"><button className="os-btn soft" onClick={() => void load()} disabled={loading}><RefreshCw className={loading ? "animate-spin" : ""}/>Refresh Status</button></div></header>
