...
function GeoSection({ rows, summary }: { rows: Row[]; summary: { visibility: number; readiness: number; entity: number; citations: number; recommendations: string[] } }) {
  if (!rows.length) return <section className="os-card"><Empty title="No GEO audits yet" text="Run a page audit from GEO Manager to create current visibility scores."/></section>;
